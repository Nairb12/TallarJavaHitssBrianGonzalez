...
public class TestMain {
    public static void main(String[] args) {
        ...
        Producto p2 = new Producto("Pan", 15.0, 5);
        ...
        List<Producto> inventario = Arrays.asList(p1, p2, p3,p4,p5,p6,p7,p8,p9);
        ...
        // Venta con cantidades usando Map
        Map<Producto, Integer> productosVenta = new HashMap<>();
        productosVenta.put(p1, 2); // 2 Leches
        productosVenta.put(p2, 5); // 5 Panes
        productosVenta.put(p3, 1); // 1 Carne
        Venta v1 = new Venta(c1, e1, productosVenta);

        // Ejemplo de filtro stock bajo
        System.out.println("Productos con stock <5: " + service.filtrarStockBajo(inventario));
        
        // Calcular total
        System.out.println("\n Calcular el total de una venta "+ service.calcularTotal(v1));

        // Imprimir venta
        service.imprimirVenta(v1);
        System.out.println("\n Generacion de producto muestra: "+service.generarProductoMuestra());

        // Ejemplo descuento
        Producto pDescuento = service.aplicarDescuento(p3);
        System.out.println("\n Producto con descuento: " + pDescuento);
        
        // Generar ticket y actualizar inventario
        service.generarTicket(c2, v1, inventario);
        
        // Ver inventario actualizado desde el main
        System.out.println("=== INVENTARIO FINAL ===");
        inventario.forEach(p -> System.out.println(p.getNombre() + " stock: " + p.getStock()));
